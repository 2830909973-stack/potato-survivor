...
export const WAVE_CONFIGS: WaveConfig[] = [
  ...
  { enemies: [{ type: "fast", count: 45 }, { type: "charger", count: 35 }, { type: "exploder", count: 28 }, { type: "ranged", count: 30 }], speedMult: 1.5, hpMult: 1.5, eliteChance: 0.08 },
  { enemies: [{ type: "normal", count: 50 }, { type: "charger", count: 35 }, { type: "exploder", count: 25 }, { type: "ranged", count: 30 }], speedMult: 1.6, hpMult: 1.6, eliteChance: 0.1 },
  { enemies: [{ type: "fast", count: 50 }, { type: "charger", count: 35 }, { type: "exploder", count: 28 }, { type: "tank", count: 25 }], speedMult: 1.7, hpMult: 1.7, eliteChance: 0.12 },
  { enemies: [{ type: "normal", count: 55 }, { type: "fast", count: 40 }, { type: "charger", count: 35 }, { type: "exploder", count: 30 }], speedMult: 1.8, hpMult: 1.8, eliteChance: 0.15 },
  { enemies: [{ type: "fast", count: 45 }, { type: "charger", count: 35 }, { type: "exploder", count: 30 }, { type: "tank", count: 30 }, { type: "ranged", count: 25 }], speedMult: 1.9, hpMult: 1.9, eliteChance: 0.15 },
